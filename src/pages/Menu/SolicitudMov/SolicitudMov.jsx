...
export default function SolicitudMov() {
  ...
  const formik = useFormik({
    initialValues: data.numero_solicitud
      ...
      : {
          ...data,
          numero_solicitud: correlativoTabla(),
        },
    ...
    validate: (data) => {
      ...
      if (!data.tipo_requerimiento) {
        errors.tipo_requerimiento = "Tipo requerimiento es requerido.";
      }
      ...
      if (data.id_solicitud) {
        dispatch(
          putRegistroSolicitudSlice({
            ...
            perito_asignado: data.perito_asignado
              ? data.perito_asignado.name
              : "",
          })
        );
        toast.current.show({
