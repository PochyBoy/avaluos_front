...
export default function DataTableFormSolicitud({
  dt,
  products,
  selectedProducts,
  setSelectedProducts,
  ...
  header,
  actionBodyTemplate,
  actionBodyTemplatePDF,
  actionBodyTemplate2,
  ColumnNameDataTable,
  actionBodyTemplateLocalizacion,
}) {
  return (
    <>
      <DataTable
      ...
      >
        ...
        <Column body={actionBodyTemplatePDF}></Column>
        <Column body={actionBodyTemplateLocalizacion}></Column>
